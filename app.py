...
def main():
    ...
    st.markdown(
        ...
        <h6>Made by
            ...
            &nbsp;|&nbsp;
            <a href="https://www.linkedin.com/in/pkb1202" target="_blank" rel="noopener noreferrer" onclick="window.open('https://www.linkedin.com/in/pkb1202'); return false;">Prabhanjana K</a></h6>
        </div>
        """,
